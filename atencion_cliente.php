...
<html lang="en">
 ...
 <?php include "includes/navbar.php"?>
    ...
    <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('images/freezer.jpg');">
      <div class="container">
            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Escribe tu sugerencia o pregunta"></textarea>
                </div>
              </div>
